...
// 	for _, tt := range tests {
// 		t.Run(tt.name, func(t *testing.T) {
// 			got, gotErr := executePipeline(tt.jm, tt.p)
// 			if gotErr != nil {
// 				if !tt.wantErr {
// 					t.Errorf("executePipeline() failed: %v", gotErr)
// 				}
// 				return
// 			}
// 			if tt.wantErr {
// 				t.Fatal("executePipeline() succeeded unexpectedly")
// 			}
// 			// TODO: update the condition below to compare got with tt.want.
// 			if true {
// 				t.Errorf("executePipeline() = %v, want %v", got, tt.want)
// 			}
// 		})
// 	}
// }
